...
var sum = function(array) {
	...
	// when the array is empty it stops the call stack 
	 //if not empty, take the first element of the array and calls the function with the input array 
	 //minus the first element till it is completely empty
...
var range = function(x, y) {
	...
	//base case is when the value of x = y
	//when the base case is hit return the result array
	// the function pushes the value x in the result array
	// and recursively call the range function with x+1
	// concat the result of the recursive call to the main result
	if( x === y){
		return [];
	}
	if(x > y){
...
var capitalizeWords = function(array) {
  ...
  return result.concat(capitalizeWords(array.splice(1)));
};
...
var capitalizeFirst = function(array) {
  ...
  return result.concat(capitalizeFirst(array.splice(1)));
};
